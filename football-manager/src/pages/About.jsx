...
const About = () => {
    ...
    return (
        <div className="p-4 md:p-8">
            <h1 className="text-2xl font-bold mb-4 tracking-wider text-neutral-600">About Our Football Manager App</h1>
            ...
            <div className="flex flex-col items-center justify-center md:justify-between">
                <div>
                    <h2 className="text-2xl font-bold mb-3 mt-8 text-center tracking-wider text-neutral-600">Meet the Project Owner</h2>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <svg
                                        ...
                                        className={`h-6 w-6 animate-bounce ${showOwner ? "text-neutral-700" : "text-emerald-600"
                                            }`}
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
